...
(function(exports) {
  ...
  var HasElmPortVersionFields = function (extractFields) {
  ...
  var hasElmPortVersionAndFieldsNil = new HasElmPortVersionFields(function (v) {
      return Data_Monoid.mempty(Data_List_Types.monoidList);
  });
  var extractFields = function (dict) {
      return dict.extractFields;
  };
  var hasElmPortVersionAndFieldsCons = function (dictIsSymbol) {
      return function (dictHasElmPortVersion) {
          return function (dictHasElmPortVersionFields) {
              return new HasElmPortVersionFields(function (v) {
                  var tyName = toElmTypeRep(dictHasElmPortVersion)(Type_Proxy["Proxy"].value);
                  var rest = extractFields(dictHasElmPortVersionFields)(Type_Row.RLProxy.value);
  ...
  var hasElmPortVersionRecord = function (dictRowToList) {
      return function (dictHasElmPortVersionFields) {
          return new HasElmPortVersion(function (v) {
              var contents = Data_Foldable.intercalate(Data_List_Types.foldableList)(Data_Monoid.monoidString)("\x0a  , ")(extractFields(dictHasElmPortVersionFields)(Type_Row.RLProxy.value));
              return "{" + (contents + "}");
          });
      };
  };
  ...
  exports["HasElmPortVersionFields"] = HasElmPortVersionFields;
  ...
  exports["hasElmPortVersionAndFieldsCons"] = hasElmPortVersionAndFieldsCons;
  exports["hasElmPortVersionAndFieldsNil"] = hasElmPortVersionAndFieldsNil;
})(PS["Kancho"] = PS["Kancho"] || {});
...
(function(exports) {
  ...
  var moveCursor = function (direction) {
      return function (v) {
          ...
          var cursor$prime = (function () {
              ...
              if (direction instanceof UpRight) {
                  var $65 = {};
                  ...
                  $65.y = v.etchSketch.cursor.y - 1 | 0;
                  return $65;
              };
              if (direction instanceof UpLeft) {
                  var $68 = {};
                  for (var $69 in v.etchSketch.cursor) {
                      if ({}.hasOwnProperty.call(v.etchSketch.cursor, $69)) {
                          $68[$69] = v["etchSketch"]["cursor"][$69];
                      };
                  };
                  $68.x = v.etchSketch.cursor.x - 1 | 0;
                  $68.y = v.etchSketch.cursor.y - 1 | 0;
                  return $68;
              };
              if (direction instanceof DownRight) {
                  var $71 = {};
                  for (var $72 in v.etchSketch.cursor) {
                      if ({}.hasOwnProperty.call(v.etchSketch.cursor, $72)) {
                          $71[$72] = v["etchSketch"]["cursor"][$72];
                      };
                  };
                  $71.x = v.etchSketch.cursor.x + 1 | 0;
                  $71.y = v.etchSketch.cursor.y + 1 | 0;
                  return $71;
              };
              if (direction instanceof DownLeft) {
                  var $74 = {};
                  for (var $75 in v.etchSketch.cursor) {
                      if ({}.hasOwnProperty.call(v.etchSketch.cursor, $75)) {
                          $74[$75] = v["etchSketch"]["cursor"][$75];
                      };
                  };
                  $74.x = v.etchSketch.cursor.x - 1 | 0;
                  $74.y = v.etchSketch.cursor.y + 1 | 0;
                  return $74;
              };
              throw new Error("Failed pattern match at Main line 91, column 15 - line 99, column 59: " + [ direction.constructor.name ]);
          })();
          var $77 = isInvalidPoint(v)(cursor$prime);
          if ($77) {
              return v;
          };
          var $81 = {};
          ...
          $81.etchSketch = (function () {
              var $78 = {};
              for (var $79 in v.etchSketch) {
                  if ({}.hasOwnProperty.call(v.etchSketch, $79)) {
                      $78[$79] = v["etchSketch"][$79];
                  };
              };
              $78.cursor = cursor$prime;
              $78.points = points$prime;
              return $78;
          })();
          return $81;
      };
  ...
  var ui = (function () {
      ...
      var error$prime = function ($116) {
          return Control_Monad_Aff_Class.liftAff(Halogen_Query_HalogenM.monadAffHalogenM(Control_Monad_Aff_Class.monadAffAff))(Control_Monad_Aff_Console.error($116));
      };
      var $$eval = function (v) {
                  ...
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)((function () {
                      if (v1 instanceof Data_Maybe.Just) {
                          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_Eff_Class.liftEff(Halogen_Query_HalogenM.monadEffHalogenM(Control_Monad_Aff.monadEffAff))($foreign.getElmInstance(v1.value0)))(function (v2) {
                              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query_HalogenM.subscribe(Halogen_Query_EventSource.eventSource(Control_Monad_Aff_Class.monadAffAff)($foreign.subscribeToClearScreen_(v2))(function ($117) {
                                  return Data_Maybe.Just.create(Halogen_Query.request(ClearScreen.create($117)));
                              })))(function () {
                                  return Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v3) {
                                      ...
                                      $92.elmInstance = new Data_Maybe.Just(v2);
                                      return $92;
                                  });
                              });
                          });
                      ...
                      throw new Error("Failed pattern match at Main line 152, column 7 - line 160, column 7: " + [ v1.constructor.name ]);
                  })())(function () {
          ...
          if (v instanceof ClearScreen) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                  ...
                  $102.etchSketch = (function () {
                      var $99 = {};
                      for (var $100 in v1.etchSketch) {
                          if ({}.hasOwnProperty.call(v1.etchSketch, $100)) {
                              $99[$100] = v1["etchSketch"][$100];
                          };
                      };
                      $99.points = Data_Monoid.mempty(Data_Monoid.monoidArray);
                      return $99;
                  })();
                  return $102;
              }))(function () {
                  ...
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)((function () {
                      if (v1.elmInstance instanceof Data_Maybe.Just) {
                          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(Data_Unit.unit))(function () {
                              return Control_Monad_Eff_Class.liftEff(Halogen_Query_HalogenM.monadEffHalogenM(Control_Monad_Aff.monadEffAff))($foreign.sendModelUpdate(v1.elmInstance.value0)(Kancho.toElmModel(Kancho.hasElmPortVersionRecord()(Kancho.hasElmPortVersionAndFieldsCons(new Data_Symbol.IsSymbol(function () {
                                  return "cursor";
                              }))(hepvCoords)(Kancho.hasElmPortVersionAndFieldsCons(new Data_Symbol.IsSymbol(function () {
                                  return "height";
                              }))(Kancho.hasElmPortVersionInt)(Kancho.hasElmPortVersionAndFieldsCons(new Data_Symbol.IsSymbol(function () {
                                  return "increment";
                              }))(Kancho.hasElmPortVersionInt)(Kancho.hasElmPortVersionAndFieldsCons(new Data_Symbol.IsSymbol(function () {
                                  return "points";
                              }))(Kancho.hasElmPortVersionArray(hepvCoords))(Kancho.hasElmPortVersionAndFieldsCons(new Data_Symbol.IsSymbol(function () {
                                  return "width";
                              }))(Kancho.hasElmPortVersionInt)(Kancho.hasElmPortVersionAndFieldsNil)))))))(v1.etchSketch)));
                          });
                      };
                      if (v1.elmInstance instanceof Data_Maybe.Nothing) {
                          return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(Data_Unit.unit);
                      };
                      throw new Error("Failed pattern match at Main line 173, column 7 - line 179, column 20: " + [ v1.elmInstance.constructor.name ]);
                  })())(function () {
                      return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value0);
                  });
              });
          };
          throw new Error("Failed pattern match at Main line 149, column 5 - line 149, column 66: " + [ v.constructor.name ]);
      };
  ...
  var directions = (function () {
      var toDirection = function (set) {
          if (Data_Set.member(Data_Ord.ordInt)(38)(set) && Data_Set.member(Data_Ord.ordInt)(39)(set)) {
              return new Data_Maybe.Just(UpRight.value);
          };
          if (Data_Set.member(Data_Ord.ordInt)(38)(set) && Data_Set.member(Data_Ord.ordInt)(37)(set)) {
              return new Data_Maybe.Just(UpLeft.value);
          };
          if (Data_Set.member(Data_Ord.ordInt)(40)(set) && Data_Set.member(Data_Ord.ordInt)(39)(set)) {
              return new Data_Maybe.Just(DownRight.value);
          };
          if (Data_Set.member(Data_Ord.ordInt)(40)(set) && Data_Set.member(Data_Ord.ordInt)(37)(set)) {
              return new Data_Maybe.Just(DownLeft.value);
          };
          ...
          throw new Error("Failed pattern match at Main line 189, column 5 - line 198, column 28: " + [ set.constructor.name ]);
      };
  ...
  var main = Halogen_Aff_Util.runHalogenAff(Control_Bind.bind(Control_Monad_Aff.bindAff)(Halogen_Aff_Util.awaitBody)(function (v) {
      return Control_Bind.bind(Control_Monad_Aff.bindAff)(Halogen_VDom_Driver.runUI(ui)(Data_Unit.unit)(v))(function (v1) {
          return Control_Bind.bind(Control_Monad_Aff.bindAff)(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(FRP_Behavior.animate(directions)(function (v2) {
              if (v2 instanceof Data_Maybe.Just) {
              ...
              throw new Error("Failed pattern match at Main line 215, column 5 - line 219, column 27: " + [ v2.constructor.name ]);
          })))(function (v2) {
