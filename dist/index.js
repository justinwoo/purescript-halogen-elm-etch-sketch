...
(function(exports) {
  ...
  var stateToElmModel = function (state) {
      var coordsToElmCoords = function (v) {
          return {
              x: v.value0, 
              y: v.value1
          };
      ...
      return {
          ...
          points: Data_Functor.map(Data_Functor.functorArray)(coordsToElmCoords)(Data_Array.fromFoldable(Data_Set.foldableSet)(state.points)), 
          width: state.width, 
          height: state.height, 
  ...
  var isInvalidPoint = function (v) {
      return function (v1) {
          ...
          throw new Error("Failed pattern match at Main line 84, column 1 - line 89, column 22: " + [ v.constructor.name, v1.constructor.name ]);
      };
  };
  ...
  var moveCursor = function (direction) {
      return function (v) {
          ...
          var cursor$prime = (function () {
              if (direction instanceof KUp) {
                  return new Coords(v.cursor.value0, v.cursor.value1 - 1 | 0);
              };
              if (direction instanceof KDown) {
                  return new Coords(v.cursor.value0, v.cursor.value1 + 1 | 0);
              };
              if (direction instanceof KLeft) {
                  return new Coords(v.cursor.value0 - 1 | 0, v.cursor.value1);
              };
              if (direction instanceof KRight) {
                  return new Coords(v.cursor.value0 + 1 | 0, v.cursor.value1);
              };
              throw new Error("Failed pattern match at Main line 98, column 15 - line 102, column 33: " + [ direction.constructor.name ]);
          })();
          var $56 = isInvalidPoint(v)(cursor$prime);
          if ($56) {
              return v;
          };
          var $57 = {};
          ...
          $57.cursor = cursor$prime;
          $57.points = points$prime;
          return $57;
      };
  };
  var ui = (function () {
      ...
      var error$prime = function ($88) {
          return Control_Monad_Aff_Class.liftAff(Halogen_Query_HalogenM.monadAffHalogenM(Control_Monad_Aff_Class.monadAffAff))(Control_Monad_Aff_Console.error($88));
      };
      var $$eval = function (v) {
                  ...
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)((function () {
                      if (v1 instanceof Data_Maybe.Just) {
                          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_Eff_Class.liftEff(Halogen_Query_HalogenM.monadEffHalogenM(Control_Monad_Aff.monadEffAff))($foreign.getElmInstance(v1.value0)))(function (v2) {
                              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query_HalogenM.subscribe(Halogen_Query_EventSource.eventSource(Control_Monad_Aff_Class.monadAffAff)($foreign.subscribeToClearScreen_(v2))(function ($89) {
                                  return Data_Maybe.Just.create(Halogen_Query.request(ClearScreen.create($89)));
                              })))(function () {
                                  return Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v3) {
                                      ...
                                      $67.elmInstance = new Data_Maybe.Just(v2);
                                      return $67;
                                  });
                              });
                          });
          ...
          if (v instanceof ClearScreen) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                  ...
                  $74.points = Data_Monoid.mempty(Data_Set.monoidSet(ordCoords));
                  return $74;
              }))(function () {
              ...
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)((function () {
                      if (v1.elmInstance instanceof Data_Maybe.Just) {
                          return Control_Monad_Eff_Class.liftEff(Halogen_Query_HalogenM.monadEffHalogenM(Control_Monad_Aff.monadEffAff))($foreign.sendModelUpdate(v1.elmInstance.value0)(stateToElmModel(v1)));
                      };
                      if (v1.elmInstance instanceof Data_Maybe.Nothing) {
                          return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(Data_Unit.unit);
                      };
                      throw new Error("Failed pattern match at Main line 175, column 7 - line 179, column 20: " + [ v1.elmInstance.constructor.name ]);
                  })())(function () {
                      return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value0);
                  });
              });
          };
          throw new Error("Failed pattern match at Main line 152, column 5 - line 162, column 28: " + [ v.constructor.name ]);
      };
  ...
  var directions = (function () {
      var toDirection = function (set) {
          if (Data_Set.member(Data_Ord.ordInt)(38)(set)) {
              return new Data_Maybe.Just(KUp.value);
          };
          if (Data_Set.member(Data_Ord.ordInt)(40)(set)) {
              return new Data_Maybe.Just(KDown.value);
          };
          if (Data_Set.member(Data_Ord.ordInt)(37)(set)) {
              return new Data_Maybe.Just(KLeft.value);
          };
          if (Data_Set.member(Data_Ord.ordInt)(39)(set)) {
              return new Data_Maybe.Just(KRight.value);
          };
          if (Data_Boolean.otherwise) {
              return Data_Maybe.Nothing.value;
          };
          throw new Error("Failed pattern match at Main line 189, column 5 - line 194, column 28: " + [ set.constructor.name ]);
      };
  ...
  var main = Halogen_Aff_Util.runHalogenAff(Control_Bind.bind(Control_Monad_Aff.bindAff)(Halogen_Aff_Util.awaitBody)(function (v) {
      return Control_Bind.bind(Control_Monad_Aff.bindAff)(Halogen_VDom_Driver.runUI(ui)(Data_Unit.unit)(v))(function (v1) {
          return Control_Bind.bind(Control_Monad_Aff.bindAff)(Control_Monad_Aff["liftEff'"](FRP_Behavior.animate(directions)(function (v2) {
              ...
              throw new Error("Failed pattern match at Main line 211, column 5 - line 215, column 27: " + [ v2.constructor.name ]);
          })))(function (v2) {
  ...
  exports["main"] = main;
  exports["moveCursor"] = moveCursor;
  exports["stateToElmModel"] = stateToElmModel;
  exports["ui"] = ui;
