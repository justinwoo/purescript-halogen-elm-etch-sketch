...
(function(exports) {
  ...
  var isInvalidPoint = function (v) {
      return function (v1) {
          ...
          throw new Error("Failed pattern match at Main line 78, column 1 - line 78, column 45: " + [ v.constructor.name, v1.constructor.name ]);
      };
  };
      ...
      return function (v) {
          ...
          var cursor$prime = (function () {
              if (direction instanceof Up) {
                  ...
                  $54.y = v.etchSketch.cursor.y - 1 | 0;
                  return $54;
              };
              if (direction instanceof Down) {
                  ...
                  $57.y = v.etchSketch.cursor.y + 1 | 0;
                  return $57;
              };
              if (direction instanceof Left) {
                  var $60 = {};
                  for (var $61 in v.etchSketch.cursor) {
                      if ({}.hasOwnProperty.call(v.etchSketch.cursor, $61)) {
                          $60[$61] = v["etchSketch"]["cursor"][$61];
                      };
                  };
                  $60.x = v.etchSketch.cursor.x - 1 | 0;
                  return $60;
              };
              if (direction instanceof Right) {
                  var $63 = {};
                  for (var $64 in v.etchSketch.cursor) {
                      if ({}.hasOwnProperty.call(v.etchSketch.cursor, $64)) {
                          $63[$64] = v["etchSketch"]["cursor"][$64];
                      };
                  };
                  $63.x = v.etchSketch.cursor.x + 1 | 0;
                  return $63;
              };
              if (direction instanceof UpRight) {
                  var $66 = {};
                  for (var $67 in v.etchSketch.cursor) {
                      if ({}.hasOwnProperty.call(v.etchSketch.cursor, $67)) {
                          $66[$67] = v["etchSketch"]["cursor"][$67];
                      };
                  };
                  $66.x = v.etchSketch.cursor.x + 1 | 0;
                  $66.y = v.etchSketch.cursor.y - 1 | 0;
                  return $66;
              };
              if (direction instanceof UpLeft) {
                  var $69 = {};
                  for (var $70 in v.etchSketch.cursor) {
                      if ({}.hasOwnProperty.call(v.etchSketch.cursor, $70)) {
                          $69[$70] = v["etchSketch"]["cursor"][$70];
                      };
                  };
                  $69.x = v.etchSketch.cursor.x - 1 | 0;
                  $69.y = v.etchSketch.cursor.y - 1 | 0;
                  return $69;
              };
              if (direction instanceof DownRight) {
                  var $72 = {};
                  for (var $73 in v.etchSketch.cursor) {
                      if ({}.hasOwnProperty.call(v.etchSketch.cursor, $73)) {
                          $72[$73] = v["etchSketch"]["cursor"][$73];
                      };
                  };
                  $72.x = v.etchSketch.cursor.x + 1 | 0;
                  $72.y = v.etchSketch.cursor.y + 1 | 0;
                  return $72;
              };
              if (direction instanceof DownLeft) {
                  var $75 = {};
                  for (var $76 in v.etchSketch.cursor) {
                      if ({}.hasOwnProperty.call(v.etchSketch.cursor, $76)) {
                          $75[$76] = v["etchSketch"]["cursor"][$76];
                      };
                  };
                  $75.x = v.etchSketch.cursor.x - 1 | 0;
                  $75.y = v.etchSketch.cursor.y + 1 | 0;
                  return $75;
              };
              throw new Error("Failed pattern match at Main line 93, column 15 - line 101, column 59: " + [ direction.constructor.name ]);
          })();
          var $78 = isInvalidPoint(v)(cursor$prime);
          if ($78) {
              return v;
          };
          var $82 = {};
          ...
          $82.etchSketch = (function () {
              var $79 = {};
              for (var $80 in v.etchSketch) {
                  if ({}.hasOwnProperty.call(v.etchSketch, $80)) {
                      $79[$80] = v["etchSketch"][$80];
                  };
              };
              $79.cursor = cursor$prime;
              $79.points = points$prime;
              return $79;
          })();
          return $82;
      };
  ...
  var ui = (function () {
      ...
      var error$prime = function ($117) {
          return Control_Monad_Aff_Class.liftAff(Halogen_Query_HalogenM.monadAffHalogenM(Control_Monad_Aff_Class.monadAffAff))(Control_Monad_Aff_Console.error($117));
      };
      var $$eval = function (v) {
                  ...
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)((function () {
                      if (v1 instanceof Data_Maybe.Just) {
                          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_Eff_Class.liftEff(Halogen_Query_HalogenM.monadEffHalogenM(Control_Monad_Aff.monadEffAff))($foreign.getElmInstance(v1.value0)))(function (v2) {
                              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query_HalogenM.subscribe(Halogen_Query_EventSource.eventSource(Control_Monad_Aff_Class.monadAffAff)($foreign.subscribeToClearScreen_(v2))(function ($118) {
                                  return Data_Maybe.Just.create(Halogen_Query.request(ClearScreen.create($118)));
                              })))(function () {
                                  return Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v3) {
                                      ...
                                      $93.elmInstance = new Data_Maybe.Just(v2);
                                      return $93;
                                  });
                              });
                          });
                      ...
                      throw new Error("Failed pattern match at Main line 154, column 7 - line 162, column 7: " + [ v1.constructor.name ]);
                  })())(function () {
          ...
          if (v instanceof ClearScreen) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                  ...
                  $103.etchSketch = (function () {
                      var $100 = {};
                      for (var $101 in v1.etchSketch) {
                          if ({}.hasOwnProperty.call(v1.etchSketch, $101)) {
                              $100[$101] = v1["etchSketch"][$101];
                          };
                      };
                      $100.points = Data_Monoid.mempty(Data_Monoid.monoidArray);
                      return $100;
                  })();
                  return $103;
              }))(function () {
          ...
          if (v instanceof UpdateElm) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)((function () {
                      ...
                      throw new Error("Failed pattern match at Main line 175, column 7 - line 181, column 20: " + [ v1.elmInstance.constructor.name ]);
                  })())(function () {
                      return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value0);
                  });
              });
          };
          throw new Error("Failed pattern match at Main line 151, column 5 - line 151, column 66: " + [ v.constructor.name ]);
      };
  ...
  var directions = (function () {
      var toDirection = function (set) {
          ...
          throw new Error("Failed pattern match at Main line 191, column 5 - line 200, column 28: " + [ set.constructor.name ]);
      };
  ...
  var main = Halogen_Aff_Util.runHalogenAff(Control_Bind.bind(Control_Monad_Aff.bindAff)(Halogen_Aff_Util.awaitBody)(function (v) {
      return Control_Bind.bind(Control_Monad_Aff.bindAff)(Halogen_VDom_Driver.runUI(ui)(Data_Unit.unit)(v))(function (v1) {
          return Control_Bind.bind(Control_Monad_Aff.bindAff)(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(FRP_Behavior.animate(directions)(function (v2) {
              ...
              throw new Error("Failed pattern match at Main line 217, column 5 - line 221, column 27: " + [ v2.constructor.name ]);
          })))(function (v2) {
