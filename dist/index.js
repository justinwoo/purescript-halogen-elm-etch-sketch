...
(function(exports) {
  ...
  var HasElmTypeRepFields = function (extractFields) {
      this.extractFields = extractFields;
  };
  var toElmTypeRep = function (dict) {
      return dict.toElmTypeRep;
  }; 
  var hasElmTypeRepInt = new HasElmTypeRep(function (v) {
      return function (v1) {
          return "Int";
      };
  });
  var hasElmTypeRepFieldsNil = new HasElmTypeRepFields(function (dictRowToList) {
      return function (v) {
          return function (v1) {
  ...
  var hasElmTypeRepFieldsCons = function (dictIsSymbol) {
      return function (dictHasElmTypeRep) {
          return function (dictListToRow) {
              return function (dictHasElmTypeRepFields) {
                  return function (dictRowToList) {
                      return new HasElmTypeRepFields(function (dictRowToList1) {
                          return function (indent) {
                              return function (v) {
                                  var tyName = toElmTypeRep(dictHasElmTypeRep)(indent + 1 | 0)(Type_Proxy["Proxy"].value);
                                  var rest = extractFields(dictHasElmTypeRepFields)(dictRowToList)(indent)(Type_Proxy["Proxy"].value);
  ...
  var hasElmTypeRepRecord = function (dictHasElmTypeRepFields) {
      return function (dictRowToList) {
          return new HasElmTypeRep(function (indent) {
              return function (proxy) {
                  ...
                  var contents = Data_Foldable.intercalate(Data_List_Types.foldableList)(Data_Monoid.monoidString)("\x0a" + (space + ", "))(extractFields(dictHasElmTypeRepFields)(dictRowToList)(indent)(proxy));
                  return "\x0a" + (space + ("{ " + (contents + ("\x0a" + (space + "}")))));
              };
          });
      };
  };
  ...
  exports["HasElmTypeRepFields"] = HasElmTypeRepFields;
  exports["hasElmTypeRepInt"] = hasElmTypeRepInt;
  exports["hasElmTypeRepRecord"] = hasElmTypeRepRecord;
  exports["hasElmTypeRepFieldsCons"] = hasElmTypeRepFieldsCons;
  exports["hasElmTypeRepFieldsNil"] = hasElmTypeRepFieldsNil;
...
(function(exports) {
  ...
  var isInvalidPoint = function (v) {
      return function (v1) {
          ...
          throw new Error("Failed pattern match at Main line 73, column 1 - line 73, column 45: " + [ v.constructor.name, v1.constructor.name ]);
      };
  };
  var hetrCoords = Kancho_Generate.hasElmTypeRepRecord(Kancho_Generate.hasElmTypeRepFieldsCons(new Data_Symbol.IsSymbol(function () {
      return "x";
  }))(Kancho_Generate.hasElmTypeRepInt)(Type_Row.listToRowCons(Type_Row.listToRowNil)())(Kancho_Generate.hasElmTypeRepFieldsCons(new Data_Symbol.IsSymbol(function () {
      return "y";
  }))(Kancho_Generate.hasElmTypeRepInt)(Type_Row.listToRowNil)(Kancho_Generate.hasElmTypeRepFieldsNil)())())();
      ...
      return function (v) {
          ...
          var cursor$prime = (function () {
              if (direction instanceof Up) {
                  var $48 = {};
                  for (var $49 in v.etchSketch.cursor) {
                      if ({}.hasOwnProperty.call(v.etchSketch.cursor, $49)) {
                          $48[$49] = v["etchSketch"]["cursor"][$49];
                      };
                  };
                  $48.y = v.etchSketch.cursor.y - 1 | 0;
                  return $48;
              };
              if (direction instanceof Down) {
                  var $51 = {};
                  for (var $52 in v.etchSketch.cursor) {
                      if ({}.hasOwnProperty.call(v.etchSketch.cursor, $52)) {
                          $51[$52] = v["etchSketch"]["cursor"][$52];
                      };
                  };
                  $51.y = v.etchSketch.cursor.y + 1 | 0;
                  return $51;
              };
              if (direction instanceof Left) {
                  var $54 = {};
                  for (var $55 in v.etchSketch.cursor) {
                      if ({}.hasOwnProperty.call(v.etchSketch.cursor, $55)) {
                          $54[$55] = v["etchSketch"]["cursor"][$55];
                      };
                  };
                  $54.x = v.etchSketch.cursor.x - 1 | 0;
                  return $54;
              };
              if (direction instanceof Right) {
                  var $57 = {};
                  for (var $58 in v.etchSketch.cursor) {
                      if ({}.hasOwnProperty.call(v.etchSketch.cursor, $58)) {
                          $57[$58] = v["etchSketch"]["cursor"][$58];
                      };
                  };
                  $57.x = v.etchSketch.cursor.x + 1 | 0;
                  return $57;
              };
              throw new Error("Failed pattern match at Main line 88, column 15 - line 92, column 43: " + [ direction.constructor.name ]);
          })();
          var $60 = isInvalidPoint(v)(cursor$prime);
          if ($60) {
              return v;
          };
          var $64 = {};
          ...
          $64.etchSketch = (function () {
              var $61 = {};
              for (var $62 in v.etchSketch) {
                  if ({}.hasOwnProperty.call(v.etchSketch, $62)) {
                      $61[$62] = v["etchSketch"][$62];
                  };
              };
              $61.cursor = cursor$prime;
              $61.points = points$prime;
              return $61;
          })();
          return $64;
      };
  ...
  var ui = (function () {
      ...
      var error$prime = function ($99) {
          return Control_Monad_Aff_Class.liftAff(Halogen_Query_HalogenM.monadAffHalogenM(Control_Monad_Aff_Class.monadAffAff))(Control_Monad_Aff_Console.error($99));
      };
      var $$eval = function (v) {
                  ...
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)((function () {
                      if (v1 instanceof Data_Maybe.Just) {
                          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_Eff_Class.liftEff(Halogen_Query_HalogenM.monadEffHalogenM(Control_Monad_Aff.monadEffAff))($foreign.getElmInstance(v1.value0)))(function (v2) {
                              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query_HalogenM.subscribe(Halogen_Query_EventSource.eventSource(Control_Monad_Aff_Class.monadAffAff)($foreign.subscribeToClearScreen_(v2))(function ($100) {
                                  return Data_Maybe.Just.create(Halogen_Query.request(ClearScreen.create($100)));
                              })))(function () {
                                  return Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v3) {
                                      ...
                                      $75.elmInstance = new Data_Maybe.Just(v2);
                                      return $75;
                                  });
                              });
                          });
                      ...
                      throw new Error("Failed pattern match at Main line 144, column 7 - line 152, column 7: " + [ v1.constructor.name ]);
                  })())(function () {
          ...
          if (v instanceof ClearScreen) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                  ...
                  $85.etchSketch = (function () {
                      var $82 = {};
                      for (var $83 in v1.etchSketch) {
                          if ({}.hasOwnProperty.call(v1.etchSketch, $83)) {
                              $82[$83] = v1["etchSketch"][$83];
                          };
                      };
                      $82.points = Data_Monoid.mempty(Data_Monoid.monoidArray);
                      return $82;
                  })();
                  return $85;
              }))(function () {
          ...
          if (v instanceof UpdateElm) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)((function () {
                      ...
                      throw new Error("Failed pattern match at Main line 165, column 7 - line 171, column 20: " + [ v1.elmInstance.constructor.name ]);
                  })())(function () {
                      return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value0);
                  });
              });
          };
          throw new Error("Failed pattern match at Main line 141, column 5 - line 141, column 66: " + [ v.constructor.name ]);
      };
  ...
  var directions = (function () {
      var toDirection = function (set) {
          ...
          throw new Error("Failed pattern match at Main line 181, column 5 - line 186, column 28: " + [ set.constructor.name ]);
      };
  ...
  var main = Halogen_Aff_Util.runHalogenAff(Control_Bind.bind(Control_Monad_Aff.bindAff)(Halogen_Aff_Util.awaitBody)(function (v) {
      return Control_Bind.bind(Control_Monad_Aff.bindAff)(Halogen_VDom_Driver.runUI(ui)(Data_Unit.unit)(v))(function (v1) {
          return Control_Bind.bind(Control_Monad_Aff.bindAff)(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(FRP_Behavior.animate(directions)(function (v2) {
              ...
              throw new Error("Failed pattern match at Main line 203, column 5 - line 207, column 27: " + [ v2.constructor.name ]);
          })))(function (v2) {
