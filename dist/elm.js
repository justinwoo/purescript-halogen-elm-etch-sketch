		...
		return A2(
			_elm_lang$svg$Svg$rect,
			{
				...
				_0: _elm_lang$svg$Svg_Attributes$width(
					_elm_lang$core$Basics$toString(increment)),
				_1: {
					ctor: '::',
					...
					_1: {
						...
						_0: _elm_lang$svg$Svg_Attributes$x(
							_elm_lang$core$Basics$toString(_p1.x * increment)),
						_1: {
							ctor: '::',
	...
	function (msg, model) {
		...
		if (_p3.ctor === 'UpdateModel') {
			...
			return {
				ctor: '_Tuple2',
				_0: model,
				_1: _user$project$Main$clearScreen(
					{ctor: '_Tuple0'})
			};
		}
	});
var _user$project$Main$modelUpdates = _elm_lang$core$Native_Platform.incomingPort(
	'modelUpdates',
	A2(
		_elm_lang$core$Json_Decode$andThen,
		function (cursor) {
			...
			_0: A2(
				...
				{ctor: '[]'},
				{
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html_Events$onClick(_user$project$Main$ClearScreen),
							_1: {ctor: '[]'}
						},
						{
							ctor: '::',
