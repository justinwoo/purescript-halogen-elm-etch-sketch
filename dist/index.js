...
(function(exports) {
  ...
  var isInvalidPoint = function (v) {
      return function (v1) {
          ...
          if (v1.x > (Data_EuclideanRing.div(Data_EuclideanRing.euclideanRingInt)(v.etchSketch.width)(v.etchSketch.increment) - 1 | 0)) {
              return true;
          };
          if (v1.y > (Data_EuclideanRing.div(Data_EuclideanRing.euclideanRingInt)(v.etchSketch.height)(v.etchSketch.increment) - 1 | 0)) {
              return true;
          };
          if (Data_Boolean.otherwise) {
              return false;
          };
          throw new Error("Failed pattern match at Main line 61, column 1 - line 61, column 45: " + [ v.constructor.name, v1.constructor.name ]);
      };
  };
      ...
      return function (v) {
          ...
          var cursor$prime = (function () {
              if (direction instanceof Up) {
                  return {
                      x: v.etchSketch.cursor.x,
                      y: v.etchSketch.cursor.y - 1 | 0
                  };
              };
              ...
              if (direction instanceof Left) {
                  return {
                      x: v.etchSketch.cursor.x - 1 | 0,
                      y: v.etchSketch.cursor.y
                  };
              };
              ...
              throw new Error("Failed pattern match at Main line 76, column 15 - line 84, column 59: " + [ direction.constructor.name ]);
          })();
          var $54 = isInvalidPoint(v)(cursor$prime);
          if ($54) {
              return v;
          };
          return {
              elmInstance: v.elmInstance,
              etchSketch: {
                  cursor: cursor$prime,
                  points: points$prime,
                  height: v.etchSketch.height,
                  width: v.etchSketch.width,
                  increment: v.etchSketch.increment
              }
          };
      };
  };
  var ui = (function () {
      ...
      var error$prime = function ($87) {
          return Effect_Aff_Class.liftAff(Halogen_Query_HalogenM.monadAffHalogenM(Effect_Aff_Class.monadAffAff))(Effect_Class_Console.error(Effect_Aff.monadEffectAff)($87));
      };
      var $$eval = function (v) {
          if (v instanceof Init) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query.getHTMLElementRef("root"))(function (v1) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)((function () {
                      if (v1 instanceof Data_Maybe.Just) {
                          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(Effect_Aff.monadEffectAff))($foreign.getElmInstance(v1.value0)))(function (v2) {
                              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query_HalogenM.subscribe(Halogen_Query_EventSource.eventSource(Effect_Aff_Class.monadAffAff)($foreign.subscribeToClearScreen_(v2))(function ($88) {
                                  return Data_Maybe.Just.create(Halogen_Query.request(ClearScreen.create($88)));
                              })))(function () {
                                  return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v3) {
                                      ...
                                      $63.elmInstance = new Data_Maybe.Just(v2);
                                      return $63;
                                  });
                              });
                          });
                      ...
                      throw new Error("Failed pattern match at Main line 127, column 7 - line 135, column 7: " + [ v1.constructor.name ]);
                  })())(function () {
          ...
          if (v instanceof MoveCursor) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(moveCursor(v.value0)))(function () {
          ...
          if (v instanceof ClearScreen) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                  ...
                  $73.etchSketch = (function () {
                      var $70 = {};
                      for (var $71 in v1.etchSketch) {
                          if ({}.hasOwnProperty.call(v1.etchSketch, $71)) {
                              $70[$71] = v1["etchSketch"][$71];
                          };
                      };
                      $70.points = Data_Monoid.mempty(Data_Monoid.monoidArray);
                      return $70;
                  })();
                  return $73;
              }))(function () {
                  ...
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)((function () {
                      if (v1.elmInstance instanceof Data_Maybe.Just) {
                          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(Data_Unit.unit))(function () {
                              return Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(Effect_Aff.monadEffectAff))($foreign.sendModelUpdate(v1.elmInstance.value0)(Kancho.toElmModel(Kancho.hasElmPortVersionRecord()(Kancho.hasElmPortVersionAndFieldsCons(new Data_Symbol.IsSymbol(function () {
                                  return "cursor";
                      ...
                      throw new Error("Failed pattern match at Main line 148, column 7 - line 154, column 20: " + [ v1.elmInstance.constructor.name ]);
                  })())(function () {
                      return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value0);
                  });
              });
          };
          throw new Error("Failed pattern match at Main line 124, column 5 - line 124, column 57: " + [ v.constructor.name ]);
      };
  ...
  var directions = (function () {
      ...
      return Data_Functor.map(FRP_Event.functorEvent)(toDirection)(FRP_Event_Keyboard.down);
  })();
  var main = Halogen_Aff_Util.runHalogenAff(Control_Bind.bind(Effect_Aff.bindAff)(Halogen_Aff_Util.awaitBody)(function (v) {
      return Control_Bind.bind(Effect_Aff.bindAff)(Halogen_VDom_Driver.runUI(ui)(Data_Unit.unit)(v))(function (v1) {
          return Control_Bind.bind(Effect_Aff.bindAff)(Effect_Class.liftEffect(Effect_Aff.monadEffectAff)(FRP_Event.subscribe(directions)(function (v2) {
              if (v2 instanceof Data_Maybe.Just) {
                  return Data_Functor["void"](Effect.functorEffect)(Effect_Aff.launchAff(v1.query(Halogen_Query.action(MoveCursor.create(v2.value0)))));
              };
              if (v2 instanceof Data_Maybe.Nothing) {
                  return Control_Applicative.pure(Effect.applicativeEffect)(Data_Unit.unit);
              };
              throw new Error("Failed pattern match at Main line 176, column 5 - line 180, column 27: " + [ v2.constructor.name ]);
          })))(function (v2) {
              return Effect_Class_Console.log(Effect_Aff.monadEffectAff)("Running");
          });
      });
  }));
  exports["Up"] = Up;
